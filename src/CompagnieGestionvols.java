	...
	public CompagnieGestionvols() {
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(lblerror.getText().equals("") && lblerror1.getText().equals("") && lblerror2.getText().equals("") && lblerror3.getText().equals("")){
				if(!numerofield.getText().equals("") && !aeroportafield.getText().equals("") && !aeroportdfield.getText().equals("") && !heuredfield.getText().equals("") && !heureafield.getText().equals("") && !nbescalesfield.getText().equals("") && !nbpassagersfield.getText().equals("") && !fretfield.getText().equals("")){
		...
		typebox.setModel(new DefaultComboBoxModel(new String[] {"Commercial Regulier", "Commercial Occasionnel", "Humanitaire", "Gouvernemental ou Militaire", "Non Commercial"}));
	 ...
	 public void remplirpilote(){
		 ...
		 String sql =" select * from membre where nom = '"+compagniebox.getSelectedItem().toString()+"'and fonction = '"+cString+"'";
