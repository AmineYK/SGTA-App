 ...
 Character ccc;
	...
	public CompagnieGestionAeronefs() {
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(lblerror.getText().equals("") && lblerror1.getText().equals("") && lblerror2.getText().equals("") && lblerror4.getText().equals("")){
				if(!numerofield.getText().equals("") && !nomconsfield.getText().equals("") && !poidsfield.getText().equals("") && !nbpassfield.getText().equals("") && !fretfield.getText().equals("") ){
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String id = aeronefstable.getModel().getValueAt(ligne,0).toString();
				if(lblerror.getText().equals("") && lblerror1.getText().equals("") && lblerror2.getText().equals("") && lblerror4.getText().equals("")){
				String sql = " update aeronef set num_aerof = ? , type = ? , nom_constructeur = ? , poids = ? , nb_passagers = ? , fret = ? , categorie = ? , nom = ? where num_aerof ="+id+" ";
		...
		numerofield.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				/*try {
					int i = Integer.parseInt(numerofield.getText());
					lblerror.setText("");
				} catch (NumberFormatException e2) {
					lblerror.setText("Champ Invalide");
				}*/
				ccc = e.getKeyChar();
		...
		nbpassfield.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				/*try {
					int i = Integer.parseInt(nbpassfield.getText());
					lblerror1.setText("");
				} catch (NumberFormatException e2) {
					lblerror1.setText("Champ Invalide");
				}*/
				ccc = e.getKeyChar();
				if(Character.isLetter(ccc)){
		...
		fretfield.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				/*try {
					int i = Integer.parseInt(fretfield.getText());
					lblerror2.setText("");
				} catch (NumberFormatException e2) {
					lblerror2.setText("Champ Invalide");
				}*/
				ccc = e.getKeyChar();
				if(Character.isLetter(ccc)){
		...
		poidsfield.addKeyListener(new KeyAdapter() {
			...
			public void keyTyped(KeyEvent e) {
				/*try {
					int i = Integer.parseInt(poidsfield.getText());
					lblerror4.setText("");
				} catch (NumberFormatException e2) {
					lblerror4.setText("Champ Invalide");
				}*/
				ccc = e.getKeyChar();
				if(Character.isLetter(ccc)){
		...
		categoriebox.setModel(new DefaultComboBoxModel(new String[] {"De Sport et de Loisirs ", "Commerciaux", "A Services divers", "A Usage militaire"}));
		...
		typebox.setModel(new DefaultComboBoxModel(new String[] {"Aeronef civil", "Aeronef militaire", "H\u00E9licoptaire civil", "Helicptaire militaire", "Aeronef bombardier", "Aeronef cargo ravitailleur"}));
	...
	public void updatetable(){
		...
		String pr="Privé";
			...
			String sql="select * from aeronef where  categorie <> '"+pr+"' and nom = '"+nomBox.getSelectedItem().toString()+"'";
		try{	
			prepared=cnx.prepareStatement(sql);
			resultat=prepared.executeQuery();
