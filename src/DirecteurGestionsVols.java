...
public class DirecteurGestionsVols extends JFrame {
	...
	public DirecteurGestionsVols() {
		...
		btnConfirmer.addActionListener(new ActionListener() {
	        ...
	        if(!aeroportAfield.getText().equals("") && !aeroportDfiled.getText().equals("") && !heureDfield.getText().equals("") && !heureAfield.getText().equals("") && !nbescalefield.getText().equals("") && !nbpassagersfield.getText().equals("") && !fretfield.getText().equals("")){ 	
			try {
