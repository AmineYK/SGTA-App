	...
	public DirecteurGestionOperateur() {
		...
		btnAjouter.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(!matriculefield.getText().equals("") && !nomfield.getText().equals("") && !prenomfield.getText().equals("") && !exprfield.getText().equals("")){
				try {
		...
		btnSupprimer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				int a =JOptionPane.showConfirmDialog(null,"Voulez-vous vraiment supprimé","Suppression Operateur",JOptionPane.YES_NO_OPTION);
		...
		btnModifier.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				String sql = "update operateurusers set matricule = ? , nom = ? , prenom = ? , nbexpr =  ? where matricule = "+id+" ";
