...
public class FenCompagnie extends JFrame {
	...
	public FenCompagnie() {
		...
		mnGestionDesMembres.setIcon(new ImageIcon(getClass().getResource("/icons8-casquette-de-pilote-de-l'air-25.png")));
		...
		mnGestionsDesVols.setIcon(new ImageIcon("C:\\Users\\m2k\\Desktop\\Amine YKh\\amine\\PROJET GL\\Les Icones\\icons8-british-airways-25 (1).png"));
		...
		btnVoirReponse.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				JOptionPane.showMessageDialog(null,"Votre Demande de Piste a ete bien traité ; "
						...
						+ "demande dans la FICHE D'INFORMATION "
						+ "sinon Consultez les Suggestions de Dates !!");
		...
		btnVoirNombreDe.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
			String sql ="select count(*) from demande where nom = '"+nombox.getSelectedItem().toString()+"'";int cpt = 0;
			try {
				prepared=cnx.prepareStatement(sql);
	...
	public void updatetable(){
		...
		try {
			...
			String sql1="select * from listevols where nom='"+nom+"'";
			prepared1=cnx1.prepareStatement(sql1);
			resultat1=prepared1.executeQuery();
			listetable.setModel(DbUtils.resultSetToTableModel(resultat1));
		} catch (SQLException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}*/
	...
	public void updatetable1(){
		...
		try {
			...
			cnx1=ConnexionMySql.ConnectionDB();
			String sql1="select * from facture where nom_compagnie='"+nom+"'";
			prepared1=cnx1.prepareStatement(sql1);
			resultat1=prepared1.executeQuery();
