		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (!idfield.getText().equals("") && !nomfield.getText().equals("")
						&& !paysfield.getText().equals("")) {
					try {
						int a = JOptionPane.showConfirmDialog(null,
								"Voulez-vous vraiment placer cette Compagnie en Liste Noire ?!", "Ajout en Liste Noire",
						...
						if (a == 0) {
							 ...
							 * sql1="delete from compagnieusers where nom= '"+nomfield.getText().toString()+
							 * "'"; prepared1=cnx1.prepareStatement(sql1); prepared1.execute();
							 */
							dispose();
						}
